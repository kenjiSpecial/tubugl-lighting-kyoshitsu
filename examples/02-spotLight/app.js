...
import { SpotLightHelper } from '../../src/spotLightHelper';
...
const spotLightShader = {
	vertexSrc: require('../../src/spotLighting/shader.vert'),
	fragmentSrc: require('../../src/spotLighting/shader.frag')
};
...
export default class App {
	...
	_makeSphere() {
		...
		this._sphere = new CustomSphere(
			this.gl,
			{
				vertexShaderSrc: spotLightShader.vertexSrc,
				fragmentShaderSrc: spotLightShader.fragmentSrc,
				isWire: false
			},
			side,
			15,
	...
	_makeHelper() {
		...
		this._spotLightHelper = new SpotLightHelper(this.gl, {}, this._spotLight);

		this._helpers = [gridHelper, this._spotLightHelper];
